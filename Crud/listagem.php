   ...
   <table class="table">
      ...
      <tbody>
          ...
          <tr>
              ...
              <td><td><input type="text" name="id" value="<?php echo $nome; ?>"></td>
              <td><td><input type="text" name="id" value="<?php echo $email; ?>"></td>
              <td><td><input type="text" name="id" value="<?php echo $telefone; ?>"></td>
              <td>
